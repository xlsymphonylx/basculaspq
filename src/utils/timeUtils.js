...
function formatDateToMidnightPortStandard(inputDate) {
  ...
  // Format the date as dd/MM/yyyy 00:00
  const formattedDateTime = `${day}/${month}/${year} 00:00`;
...
export {
  splitDate,
  formatDateToPortStandard,
  formatDateToMidnightPortStandard,
  getFormattedDate,
  getFormattedTime,
  combineDateTime,
};
